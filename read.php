      ...
      <!-- write code to exract the data from db and run a while loop on-->
          ...
          <div class="container" id = "readpart" >
              ...
              <div class="container row">
                <textarea name="story" rows="20" style="width: 90%;height: 100%;" disabled>
          ...
          <div class="container" id = "commentpart" >
            <div class="my-custom-scrollbar my-custom-scrollbar-primary">
                  <div id = "commentRow" class="row">
                      <h4  style="margin-left : 5px">Karthik</h4>
                      <p   style="margin-left : 5px">This story is very beautiful</p>
                  </div>
                  <div id = "commentRow" class="row">
                      <h4  style="margin-left : 5px">Adam</h4>
                      <p   style="margin-left : 5px">Hey, is Amit the Hero?</p>
                  </div>
                  <div id = "commentRow" class="row">
                      <h4  style="margin-left : 5px">Luna</h4>
                      <p   style="margin-left : 5px">Loved it</p>
                  </div>
                  <div id = "commentRow" class="row">
                      <h4  style="margin-left : 5px">Tony</h4>
                      <p   style="margin-left : 5px">Hey where's Wise man?</p>
                  </div>
                  <div id = "commentRow" class="row">
                      <h4  style="margin-left : 5px">Maria</h4>
                      <p   style="margin-left : 5px">Is he the villain?</p>
                  </div>
                  <div id = "commentRow" class="row">
                      <h4  style="margin-left : 5px">Clint</h4>
                      <p   style="margin-left : 5px">This is cool!</p>
                  </div>
            </div>
             ...
             <div class="comment"   >
               ...
               <textarea name="mycomment" style="width:80%;" placeholder="comment here"></textarea>
               <br>
