                          ...
                          echo "<div id='signin'   class = 'tab-pane fade in'>
                              <form class='form' action= 'forSign.php' method='post'>
                                <ul    id = 'signinList'>
                                  ...
                                  <li>Password: <input  class = 'form-control textarea-lg'  type='password' name='pwd'  placeholder='Enter Password'></li>
                            ...
                            echo "<div  id = 'Signup' class='tab-pane fade in active'>
                              <form class='form' action = 'forSignup.php' method='post'>
                                <ul    id = 'signinList'>
                                  ...
                                  <li> Username : <input  class = 'form-control textarea-lg'   type='text' name='username' placeholder='Enter a Username'></li>
